...
public class SystemVariableServiceDelegate extends ServiceDelegateSupport {
     ...
     */
    public SystemVariableMsg getSystemVariables(EmptyServiceMessage message, ServiceSubContext... subContexts)
            throws ClientException {
        ...
        throw new ClientException("Cannot execute service operation: SystemVariableService.getSystemVariables");
    }
}
