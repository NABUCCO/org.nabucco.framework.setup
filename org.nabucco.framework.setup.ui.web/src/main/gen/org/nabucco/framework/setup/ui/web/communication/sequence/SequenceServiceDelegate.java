 ...
 */
package org.nabucco.framework.setup.ui.web.communication.sequence;
...
public class SequenceServiceDelegate extends ServiceDelegateSupport {
     ...
     */
    public SequenceRs generateSequence(SequenceRq message, NabuccoSession session, ServiceSubContext... subContexts)
            throws SequenceException {
        ServiceRequest<SequenceRq> request = new ServiceRequest<SequenceRq>(super.createServiceContext(session,
                subContexts));
        ...
        throw new SequenceException("Cannot execute service operation: SequenceService.generateSequence");
    }
}
