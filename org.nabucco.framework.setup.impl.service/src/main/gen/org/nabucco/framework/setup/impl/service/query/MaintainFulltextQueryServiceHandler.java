...
/**
 * MaintainFulltextQueryServiceHandler<p/>Service for managing fulltext queries.<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2011-04-13
 */
public abstract class MaintainFulltextQueryServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.setup.impl.service.query.MaintainFulltextQueryServiceHandler";

    /** Constructs a new MaintainFulltextQueryServiceHandler instance. */
    public MaintainFulltextQueryServiceHandler() {
        super();
    }
     ...
     *
     * @param msg the FulltextQueryListMsg.
     * @return the FulltextQueryListMsg.
     * @throws MaintainException
     */
    protected abstract FulltextQueryListMsg maintainFulltextQuery(FulltextQueryListMsg msg) throws MaintainException;
