 ...
 */
package org.nabucco.framework.setup.ui.rcp.communication.journal;
...
public class JournalServiceDelegate extends ServiceDelegateSupport {
     ...
     */
    public EmptyServiceMessage journal(JournalMsg message, ServiceSubContext... subContexts) throws ClientException {
        ...
        throw new ClientException("Cannot execute service operation: JournalService.journal");
    }
}
