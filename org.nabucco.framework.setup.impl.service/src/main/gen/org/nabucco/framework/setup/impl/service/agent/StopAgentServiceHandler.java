...
/**
 * StopAgentServiceHandler<p/>Service for agent administration.<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-06-09
 */
public abstract class StopAgentServiceHandler extends ServiceHandlerSupport implements ServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.setup.impl.service.agent.StopAgentServiceHandler";

    /** Constructs a new StopAgentServiceHandler instance. */
    public StopAgentServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<EmptyServiceMessage> invoke(ServiceRequest<AgentNameRq> rq) throws AgentException {
        ...
        try {
            ...
            msg = this.stopAgent(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws AgentException
     */
    protected abstract EmptyServiceMessage stopAgent(AgentNameRq msg) throws AgentException;
