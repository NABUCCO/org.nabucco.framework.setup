...
/**
 * MaintainJournalServiceHandler<p/>Service for storing the journal.<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2011-03-17
 */
public abstract class MaintainJournalServiceHandler extends PersistenceServiceHandlerSupport implements ServiceHandler,
        PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.setup.impl.service.journal.maintain.MaintainJournalServiceHandler";

    /** Constructs a new MaintainJournalServiceHandler instance. */
    public MaintainJournalServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<EmptyServiceMessage> invoke(ServiceRequest<JournalMsg> rq) throws MaintainException {
        ...
        try {
            ...
            msg = this.maintainJournal(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws MaintainException
     */
    protected abstract EmptyServiceMessage maintainJournal(JournalMsg msg) throws MaintainException;
