...
/**
 * SequenceType<p/>The sequence type.<p/>
 *
 * @version 1
 * @author Nicolas Moser, PRODYNA AG, 2011-06-01
 */
public enum SequenceType implements Enumeration {
    SEQUENCE("S"),
    DATE("D"),
    UUID("U"), ;
    ...
    /**
     * Constructs a new SequenceType instance.
     *
     * @param id the String.
     */
     ...
     */
    public static SequenceType valueOfId(String literalId) {
        for (SequenceType enumeration : SequenceType.values()) {
